...
// getSystemPrompt returns the system prompt from your original Python tool
...
- **System Design**: Specific examples
- **Testing**: Specific examples
- **Error Handling**: Specific examples
- **Code Quality**: Specific examples

### Level Assessment Table

| Area | Observed Examples | Microsoft Level | Google Level | Amazon Level |
|------|-------------------|-----------------|--------------|---------------|
| Code Quality | Specific examples | Level | Level | Level |
| System Design | Specific examples | Level | Level | Level |
| Testing | Specific examples | Level | Level | Level |
| Error Handling | Specific examples | Level | Level | Level |
| Documentation | Specific examples | Level | Level | Level |
